...
from func_prep_dicts import *
from func_create_csv_pool import create_csv_pool
...
class Querier(Goblin):
    ...
    def init_variable_dict(self):
        ...
        print('Success: Querier has initiated a variable dictionary in:' + str(self.meta_dir) + '/csv_source_dict_demo.json')
